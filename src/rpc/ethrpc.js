...
class EthApi {
    ...
    getBalance(address: string, blockNumber: number | string = 'latest'): Promise<BigNumber> {
      return this.rpc.call('ngin_getBalance', [address, blockNumber])
    ...
    gasPrice(): Promise<BigNumber> {
      return this.rpc.call('ngin_gasPrice', [])
    ...
    getSyncing(): Promise<SyncingResult> {
      return this.rpc.call('ngin_syncing', [])
        .then((result) => {
          if (!result) {
            return false;
          }
    ...
    estimateGas(call: CallObject): Promise<number> {
      ...
      return this.rpc.call('ngin_estimateGas', [txData]).then(gas => convert.toNumber(gas));
    }
    ...
    getBlockNumber(): Promise<number> {
      return this.rpc.call('ngin_blockNumber', [])
    ...
    getTransactionCount(address: string, blockNumber: number | string = 'latest'): Promise<any> {
      return this.rpc.call('ngin_getTransactionCount', [address, blockNumber])
    ...
    getTransactionReceipt(hash: string): Promise<any> {
      return this.rpc.call('ngin_getTransactionReceipt', [hash])
    ...
    getTransaction(hash: string): Promise<any> {
      return this.rpc.call('ngin_getTransactionByHash', [hash])
