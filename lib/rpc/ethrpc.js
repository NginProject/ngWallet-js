  ...
  var EthApi = function () {
    ...
    _createClass(EthApi, [{
      ...
      value: function getAddressTransactions(address, blockNumFloor, blockNumCeil, toOrFrom, standardOrContract, beginPageIndex, endPageIndex, orderByOldest) {
        return this.rpc.call('ngin_getAddressTransactions', [address, blockNumFloor, blockNumCeil, toOrFrom, standardOrContract, beginPageIndex, endPageIndex, orderByOldest]);
      }
    }]);
